...
feature. No generated match footage or simulated football scene is used.
...
## Current rendering gate

The prior local rehearsal is superseded by this professional treatment. Promote
no new hash until the visual audit confirms all eleven disclosed overlays and the
four-cut first audit, and the narration audit confirms 8/8 fitted cues, burned-in
captions, professional speech loudness, VP8/Opus streams, and a sub-60-second
duration. The accepted upload candidate must then be regenerated from the exact
frozen public URL.
