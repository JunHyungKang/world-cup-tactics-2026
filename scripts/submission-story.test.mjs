...
describe("submission story", () => {
  ...
  it("rejects campaign, interaction, and claim-boundary drift", () => {
    ...
    expect(validateSubmissionStory(interaction, sources)).toContain("video interaction contract must preserve 12 events, 8 activations, one lock, two scrolls, the 34.009s receipt, and the 48.037s next-meeting note");
