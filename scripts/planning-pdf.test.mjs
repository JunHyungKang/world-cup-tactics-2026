...
beforeAll(async () => {
  ...
  const binding = `DAKER · 기획서 인간 연구 없음 인과 추천 REJECT 경험적 캠페인 REVISE 기획 ${sourceSha256.slice(0, 12)} 캡처 ${screenshotManifestSha256.slice(0, 12)} 48경기 603 397/436 WOULD_PREVENT 정책 변경 0회 60/60 다음 미팅 제출팀 60% 2026-07-27 10:00 KST`;
